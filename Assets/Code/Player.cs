...
public class Player : MonoBehaviour, ITakeDamage
{
    ...
    private void FireProjectile()
    {
        ...
        {
            FireProjectileEffect.renderer.sortingLayerName = "Player";   
    ...
    public void TakeDamage(int damage, GameObject instigator)
    {
        ...
        FloatingText.Show(string.Format("-{0}", damage), "PlayerTakeDamageText",
            new FromWorldPointTextPositioner(Camera.main, transform.position, 2.0f, 60));
        OuchEffect.renderer.sortingLayerName = "Particles";
